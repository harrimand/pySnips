...
class rpn:
    ...
    def help(self):
        return ("\n"+\
            "h ____ display this help\n"+\
            "+ ____ add Level 1 to Level 2\n"+\
            "* ____ muliply Level 1 by Level 2\n"+\
            "- ____ subract Level 1 from Level 2\n"+\
            "/ ____ divide Level 2 by Level 1\n"+\
            "du ___ duplicate Level 1\n"+\
            "dup2__ duplicate Level 2 and Level 1\n"+\
            "sq ___ square of Level 1\n"+\
            "sqr___ square root of Level 1\n"+\
            "^ ____ Level 2 raised to power of Level 1\n"+\
            "% ____ Level 2 modulo Level 1\n"+\
            "p ____ pick Level defined by Level 1 value\n"+\
            "pi ___ push Pi to stack\n"+\
            "1/ ___ invert (1/x) Level 1\n"+\
            "sh ___ Print stack with Level numbers\n"+\
            "dr ___ drop Level 1 from stack\n"+\
            "sw ___ swap Level 1 and Level 2\n"+\
            "clr __ clear stack\n"\
            )
